...
d3.csv("../data/vehicle_inv.csv", function(data){
  ...
  y: d => d.count,
  z: d => d.c,
  xDomain: d3.groupSort(cnt_category, D => d3.sum(D, d => -d.count), d => d.year),
...
// key = legend(chart_bar.scales, {title: "Category"}) // try also Swatches
